...
| Skill | What it does |
|---|---|
| [`/evaluate`](skills/evaluate) | Tries a pull request, a branch or a spec before you trust it. Seven jurors, one count each, instructed in parallel and sealed from one another; returns one ranked verdict and writes nothing. |
